 ...
 * Copyright (c) 2009-2011 by Receitas, Inc. All Rights Reserved.
...
//@interface ReceitasObject : NSObject
//@end

@interface ReceitasObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ReceitasObject class]])
		{
			for (NSString *key in [[(ReceitasObject*)o modules] allKeys])
			{
