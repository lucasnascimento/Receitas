...
// in simulator we redefine to format for Receitas Developer console
...
{\
	NSString * exceptionName = [@"org.receitas." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.receitas";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIReceitasNativeItemNone = -1, 
	UIReceitasNativeItemSpinner = -2,
	UIReceitasNativeItemProgressBar = -3,
	
	UIReceitasNativeItemSlider = -4,
	UIReceitasNativeItemSwitch = -5,
	UIReceitasNativeItemMultiButton = -6,
	UIReceitasNativeItemSegmented = -7,
	
	UIReceitasNativeItemTextView = -8,
	UIReceitasNativeItemTextField = -9,
	UIReceitasNativeItemSearchBar = -10,
	
	UIReceitasNativeItemPicker = -11,
	UIReceitasNativeItemDatePicker = -12,
	
	UIReceitasNativeItemInfoLight = -13,
	UIReceitasNativeItemInfoDark = -14,
	
	UIReceitasNativeItemDisclosure = -15,
	
	UIReceitasNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Receitas instances of
